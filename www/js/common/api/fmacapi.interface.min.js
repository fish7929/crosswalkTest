...
g.message)}})}catch(i){fmacapi_report_exception(i)}};function fma_getMSec(){var a=new Date;return a.getMilliseconds()}fmacloud.tpl_save_effect_img=function(a,d,b,f){if(d!=null&&d!=""){var c=a.get("effect_img");if(c.substr(0,3)=="AV:")c=c.slice(3);var h=new fmacloud.File(c+".png",{base64:d});h.save().then(function(){a.set("effect_img","AV:"+h.url());var i=Math.round(128),g=Math.round(a.get("tpl_height")*i/a.get("tpl_width"));i=h.thumbnailURL(i,g);a.set("tiny_img","AV:"+i);b(a)},f)}else b(a)};
